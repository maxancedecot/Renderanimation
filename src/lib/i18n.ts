...
const M: Record<Lang, Record<string, string>> = {
  fr: {
    ...
    cameraChoiceTitle: 'Mouvement de caméra',
    cameraChoiceHint: "Choisis le mouvement avant de lancer l'analyse.",
    cameraOptionOrbitLeftTitle: 'Orbit gauche',
    cameraOptionOrbitLeftDesc: 'Rotation lente autour de la scène vers la gauche.',
    cameraOptionForwardPushTitle: 'Avancée frontale',
    cameraOptionForwardPushDesc: "Glissement lent vers l’avant le long de l’axe de vue.",
    cameraOptionOrbitRightTitle: 'Orbit droite',
    cameraOptionOrbitRightDesc: 'Rotation lente autour de la scène vers la droite.',
    cameraSelectionLabel: 'Mouvement sélectionné : {option}',
    ...
    adminShowPrompt: 'Afficher le prompt',
    adminHidePrompt: 'Masquer le prompt',
    adminPromptTitle: 'Prompt envoyé à Kling',
  ...
  en: {
    ...
    cameraChoiceTitle: 'Camera movement',
    cameraChoiceHint: 'Pick how the camera should move before running the analysis.',
    cameraOptionOrbitLeftTitle: 'Orbit left',
    cameraOptionOrbitLeftDesc: 'Slow orbit to the left around the scene.',
    cameraOptionForwardPushTitle: 'Forward push',
    cameraOptionForwardPushDesc: 'Slow glide forward along the viewing axis.',
    cameraOptionOrbitRightTitle: 'Orbit right',
    cameraOptionOrbitRightDesc: 'Slow orbit to the right around the scene.',
    cameraSelectionLabel: 'Selected movement: {option}',
    ...
    adminShowPrompt: 'Show prompt',
    adminHidePrompt: 'Hide prompt',
    adminPromptTitle: 'Prompt sent to Kling',
    upscale4k: 'Upscale 4K',
    fourkPending: '4K in progress…',
    ra4kInProgress: 'RA 4K: in progress — This can take up to 5 minutes.',
    ra4kSending: 'RA 4K: sending…',
    klingTaskStatus: 'Task: {status}',
  ...
  nl: {
    ...
    cameraChoiceTitle: 'Camerabeweging',
    cameraChoiceHint: 'Kies hoe de camera moet bewegen voordat je analyseert.',
    cameraOptionOrbitLeftTitle: 'Orbit links',
    cameraOptionOrbitLeftDesc: 'Langzame orbit naar links rond de scène.',
    cameraOptionForwardPushTitle: 'Voorwaartse push',
    cameraOptionForwardPushDesc: 'Langzame voorwaartse glide langs de kijkas.',
    cameraOptionOrbitRightTitle: 'Orbit rechts',
    cameraOptionOrbitRightDesc: 'Langzame orbit naar rechts rond de scène.',
    cameraSelectionLabel: 'Gekozen beweging: {option}',
    ...
    adminShowPrompt: 'Prompt tonen',
    adminHidePrompt: 'Prompt verbergen',
    adminPromptTitle: 'Prompt verzonden naar Kling',
